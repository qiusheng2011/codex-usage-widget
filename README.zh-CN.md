...
- 支持在设置中自定义原红色文字对应的强调色，该颜色会应用于浮窗文字、图表主周期和菜单栏用量显示，也可以一键恢复默认红色。
...
本软件对个人、教育、科研及非营利性组织完全免费。任何公司、企业、商业项目或以盈利为目的的组织/个人，
如需使用、复制或修改本软件，必须获得原作者的书面授权并购买商业授权。
...
背景图片路径、图片透明度、强调色、自动缩放、缩放等待时间和菜单栏显示开关保存在当前用户的 `UserDefaults` 中。
